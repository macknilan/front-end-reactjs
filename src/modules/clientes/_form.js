...
//           Translations[Language.value]['add-btn'] + ' ' + Translations[Language.value]['name'],
//           Constants.SNACKBAR_ERR(props)
//         );
//         setLoading(false);
//         return;
//       }
...
//         props.enqueueSnackbar(
//           Translations[Language.value]['add-btn'] + ' ' + Translations[Language.value]['iata-code'],
//           Constants.SNACKBAR_ERR(props)
//         );
//         setLoading(false);
//         return;
...
//         props.enqueueSnackbar(
//           Translations[Language.value]['add-btn'] + ' ' + Translations[Language.value]['oaci-code'],
//           Constants.SNACKBAR_ERR(props)
//         );
//         setLoading(false);
//         return;
...
//         props.enqueueSnackbar(
//           Translations[Language.value]['add-btn'] + ' ' + Translations[Language.value]['status'],
//           Constants.SNACKBAR_ERR(props)
//         );
//         setLoading(false);
//         return;
//       }
//       const token = JSON.parse(localStorage.getItem('tokens')).id.token;
//       data.resourceData = {
//         name: name,
//         iata_code: iata,
//         icao_code: icao,
...
//       // Changing data to store to string
//       const dataString = Util.stateToQueryString(data.resourceData);

//       fetch(data.api, {
//         method: data.storeUrlMethod || 'POST',
//         headers: {
...
//               props.enqueueSnackbar(result.error_message, Constants.SNACKBAR_ERR(props));
//               setLoading(false);
//             } else {
//               props.enqueueSnackbar(
//                 Translations[Language.value]['record-saved-succesfully'],
//                 Constants.SNACKBAR_SUCCESS(props)
//               );
//               handleClosess();
//               handlesearch();
//               setLoading(false);
